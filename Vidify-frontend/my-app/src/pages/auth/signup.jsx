...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(password != confirmPassword){
      setError("Password and Confirm Password Cannot be different");
      return;
    }
    ...
    try {
      const response =  await api.post("auth/api/signup", {
          username,
          email,
          password,
        });
      ...
      console.log(error,'Ye error hai');
    ...
    >
      ...
      >
        <form
          ...
          py-10
          flex
          flex-col gap-6 border border-white/10
        ...
        >
          ...
          "
          >
            {isSubmitLoading ? "Signing in..." : "Sign Up"}
          </button>
